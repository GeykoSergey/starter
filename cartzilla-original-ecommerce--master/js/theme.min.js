...
!(function (c) {
  var e = {
      ...
      if (null != t) {
        ...
        window.addEventListener("scroll", function (e) {
          400 < e.currentTarget.pageYOffset
            ? ((document.body.style.paddingTop = o + "px"),
    ...
    passwordVisibilityToggle: function () {
      for (
        var o = document.querySelectorAll(".password-toggle"),
          e = function (e) {
            var t = o[e].querySelector(".form-control");
            o[e].querySelector(".password-toggle-btn").addEventListener(
              "click",
              function (e) {
                  ...
                  (e.onload = function (e) {
                    ...
                    if (((a.innerHTML = o), t.startsWith("data:image"))) {
                      ...
                      t.startsWith("data:video")
                        ? ((c.innerHTML = ""),
                          (c.className = ""),
                          (c.className = "cz-file-drop-icon czi-video"))
                        : ((c.innerHTML = ""),
                          (c.className = ""),
                          (c.className = "cz-file-drop-icon czi-document"));
                  }),
    ...
    productGallery: function () {
      ...
      if (l.length)
        for (
          var e = function (o) {
              for (
                var r = l[o].querySelectorAll(
                    ".cz-thumblist-item:not(.video-item)"
                  ),
                  n = l[o].querySelectorAll(".cz-preview-item"),
                  e = l[o].querySelectorAll(".cz-thumblist-item.video-item"),
                  t = 0;
                t < r.length;
                t++
              )
                r[t].addEventListener("click", a);
          ...
          e = function (e) {
            ...
            noUiSlider.create(t, {
              ...
              t.noUiSlider.on("update", function (e, t) {
                var o = e[t];
                (o = o.replace(/\D/g, "")),
                  t ? (n.value = Math.round(o)) : (r.value = Math.round(o));
              }),
        ...
        for (
          var e = function (e) {
              var o = t[e].dataset.countdown,
                ...
                s = void 0,
                u = void 0;
              if (((o = new Date(o).getTime()), isNaN(o)))
                return {
                  v: void 0,
                };
              setInterval(function () {
                  ...
                  t = parseInt((o - e) / 1e3);
                {
                  ...
                  (l = parseInt(t / 86400)),
                    ...
                    (t %= 60),
                    (u = parseInt(t)),
                    null != r && (r.innerHTML = parseInt(l, 10)),
                    null != n && (n.innerHTML = i < 10 ? "0" + i : i),
                    null != a && (a.innerHTML = s < 10 ? "0" + s : s),
                    null != c && (c.innerHTML = u < 10 ? "0" + u : u);
                }
              }, 1e3);
            },
            o = 0;
