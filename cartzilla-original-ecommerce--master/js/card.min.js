var card = (function (r) {
  ...
  function e(t) {
    ...
    var a = (n[t] = { exports: {}, id: t, loaded: !1 });
        ...
        (t = (function () {
          ...
          function n(r) {
            ...
            (this.maskCardNumber = o(this.maskCardNumber, this)),
              ...
              this.options.form
                ? ((this.$el = a(this.options.form)),
                  this.options.container
                    ? ((this.$container = a(this.options.container)),
                      (n = a.isDOMElement(this.$container)
                        ? this.$container
                        : this.$container[0]).getAttribute(
                        this.initializedDataAttr
                      ) ||
                        (n.setAttribute(this.initializedDataAttr, !0),
                        this.render(),
                        this.attachHandlers(),
          ...
          return (
            (n.prototype.initializedDataAttr = 'data-jp-card-initialized'),
            (n.prototype.cardTemplate =
            ...
            (n.prototype.render = function () {
              ...
              for (e in (d = this.options.formSelectors))
                (c = d[e]),
                  ...
                  !(t = a.find(this.$el, c)).length &&
                    this.options.debug &&
                    console.error("Card can't find a " + e + ' in your form.'),
                  (this['$' + e] = t);
              if (
                ...
                this.options.width &&
                  ((r = a(this.options.cardSelectors.cardContainer)[0]),
                  (n = parseInt(
                    r.clientWidth || window.getComputedStyle(r).width
                  )),
                  (r.style.transform =
                    'scale(' + this.options.width / n + ')')),
                ('undefined' != typeof navigator && null !== navigator
                  ...
                  -1 === p.indexOf('chrome') &&
                  a.addClass(this.$card, 'jp-card-safari'),
                /MSIE 10\./i.test(navigator.userAgent) &&
                  a.addClass(this.$card, 'jp-card-ie-10'),
            ...
            (n.prototype.attachHandlers = function () {
              var n, e;
              return (
                (e = [this.validToggler('cardNumber')]),
            ...
            (n.prototype.handleInitialPlaceholders = function () {
              var r, n, e, t;
              for (n in ((t = []), (e = this.options.formSelectors)))
                e[n],
                  (r = this['$' + n]),
                  a.val(r)
                    ? (a.trigger(r, 'paste'),
            ...
            (n.prototype.toggleValidClass = function (r, n) {
              return (
                a.toggleClass(r, this.options.classes.valid, n),
            ...
            (n.prototype.maskCardNumber = function (r, n, e) {
              var t, a;
              return (
                (t = this.options.masks.cardNumber),
                (a = r.split(' ')).length >= 3
            ...
            (n.prototype.handlers = {
              setCardType: function (r, n) {
                var e;
                if (((e = n.data), !a.hasClass(this.$card, e)))
                  return (
              ...
              return (
                ...
                a.on(r, 'keyup change paste', function (t) {
                  ...
                  for (
                    h = (function () {
                      var n, e, t;
                      for (t = [], n = 0, e = r.length; n < e; n++)
                        (i = r[n]), t.push(a.val(i));
                      return t;
                    })(),
                      p = e.join(h),
                      (h = h.join(p)) === p && (h = ''),
                      c = 0,
                      s = (b = e.filters).length;
                    c < s;
                    c++
                  )
                    h = (0, b[c])(h, r, n);
  ...
  function (r, n, e) {
    ...
    function s(r) {
      for (var n = [], e = {}, t = 0; t < r.length; t++) {
        ...
        e[i] ? e[i].parts.push(o) : n.push((e[i] = { id: i, parts: [o] }));
      }
      return n;
    }
    function g(r, n) {
      ...
      ((n = function (r) {
        ...
        (n.on = function (r, e, t) {
          ...
          if (r.length)
            ...
            for (o = 0, c = (s = e.split(' ')).length; o < c; o++)
              (p = s[o]), n.on(r, p, t);
          }
        }),
        (n.addClass = function (r, e) {
          ...
          return r.length
            ? (function () {
                var a, i, o;
                for (o = [], a = 0, i = r.length; a < i; a++)
                  (t = r[a]), o.push(n.addClass(t, e));
                return o;
              })()
            : r.classList
            ? r.classList.add(e)
        ...
        (n.removeClass = function (r, e) {
          ...
          if (r.length)
            return (function () {
              var t, i, o;
              for (o = [], t = 0, i = r.length; t < i; t++)
                (a = r[t]), o.push(n.removeClass(a, e));
              return o;
            })();
          if (r.classList) {
        ...
        (n.toggleClass = function (r, e, t) {
          ...
          return r.length
            ? (function () {
                var i, o, d;
                for (d = [], i = 0, o = r.length; i < o; i++)
                  (a = r[i]), d.push(n.toggleClass(a, e, t));
                return d;
              })()
            : t
            ? n.hasClass(r, e)
      ...
      (function () {
        ...
        (a = e(5)),
          ...
          (i = function (r) {
            var n, e, t;
            for (
              r = (r + '').replace(/\D/g, ''), e = 0, t = d.length;
              e < t;
              e++
            )
          ...
          (g = function (r) {
            var n, e, t;
            if (((n = String.fromCharCode(r.which)), /^\d+$/.test(n)))
              return (
                (e = r.target),
                (t = a.val(e) + n),
                /^\d$/.test(t) && '0' !== t && '1' !== t
          ...
          (u = function (r) {
            ...
            if ('/' === String.fromCharCode(r.which))
              return (
                ...
                (e = a.val(n)),
                /^\d$/.test(e) && '0' !== e
                  ? (a.val(n, '0' + e + ' / '), a.trigger(n, 'change'))
                  : void 0
              );
          }),
          (l = function (r) {
            ...
            if (
              !r.metaKey &&
              ((n = r.target), (e = a.val(n)), 8 === r.which && !j(n))
            )
              return /\d(\s|\/)+$/.test(e)
                ? (r.preventDefault(),
                  a.val(n, e.replace(/\d(\s|\/)*$/, '')),
          ...
          (k = function (r, n) {
            ...
            if (
              ...
              return (a.val(t) + e).replace(/\D/g, '').length > n
                ? r.preventDefault()
                : void 0;
          }),
          (y = function (r) {
            ...
            return (
              (r.fns = {
                cardExpiryVal: function (r) {
                  var n, e, t;
                  return (
                    (n = (e = (r = r.replace(/\s/g, '')).split('/', 2))[0]),
                    2 === (null != (t = e[1]) ? t.length : void 0) &&
                      /^\d+$/.test(t) &&
                      (t = new Date().getFullYear().toString().slice(0, 2) + t),
                    {
                ...
                validateCardExpiry: function (n, e) {
                  var t, i, o, d;
                  return (
                    'object' == typeof n && 'month' in n
                      ? ((n = (o = n).month), (e = o.year))
                      : 'string' == typeof n &&
                        $.call(n, '/') >= 0 &&
                        ((n = (d = r.fns.cardExpiryVal(n)).month),
                        (e = d.year)),
                    !(!n || !e) &&
                      ((n = a.trim(n)),
                      (e = a.trim(e)),
                ...
                formatCardNumber: function (r) {
                  var n, e, t, a;
                  return (n = i(r))
                    ? ((a = n.length[n.length.length - 1]),
                      (r = (r = r.replace(/\D/g, '')).slice(0, a)),
                      n.format.global
                        ? null != (t = r.match(n.format))
                          ? t.join(' ')
                          : void 0
                        : null != (e = n.format.exec(r))
                        ? (e.shift(),
              ...
              (r.formatCardExpiry = function (n) {
                ...
                return (
                  ...
                  n.length && 2 === n.length
                    ? ((e = n[0]),
                      (t = n[1]),
                      this.formatCardExpiryMultiple(e, t))
                    : (a.on(n, 'keypress', y),
                      a.on(n, 'keypress', g),
                      a.on(n, 'keypress', u),
                      a.on(n, 'keypress', f),
    ...
    var t = e(9),
      a = function r() {
        var n,
          ...
          s = !1;
        for (
          'boolean' == typeof c && ((s = c), (c = arguments[1] || {}), (p = 2)),
            'object' == typeof c || t.fn(c) || (c = {});
          p < l;
          p++
        )
          if (null != (n = arguments[p]))
            for (e in ('string' == typeof n && (n = n.split('')), n))
              (a = c[e]),
                c !== (i = n[e]) &&
                  (s && i && (t.hash(i) || (o = t.array(i)))
                    ? (o
                        ? ((o = !1), (d = a && t.array(a) ? a : []))
                        : (d = a && t.hash(a) ? a : {}),
                      (c[e] = r(s, d, i)))
    ...
    (l.a = l.type =
      ...
      (l.empty = function (r) {
        ...
        if (
          ...
          return 0 === r.length;
        if ('[object Object]' === e) {
          for (n in r) if (a.call(r, n)) return !1;
          return !0;
        }
        return !r;
      }),
      (l.equal = function (r, n) {
        ...
        if ('[object Object]' === t) {
          for (e in r) if (!(l.equal(r[e], n[e]) && e in n)) return !1;
          for (e in n) if (!(l.equal(r[e], n[e]) && e in r)) return !1;
          return !0;
        }
        if ('[object Array]' === t) {
          if ((e = r.length) !== n.length) return !1;
          for (; e--; ) if (!l.equal(r[e], n[e])) return !1;
          return !0;
        }
        return '[object Function]' === t
          ? r.prototype === n.prototype
          : '[object Date]' === t && r.getTime() === n.getTime();
      }),
      ...
      (l.maximum = function (r, n) {
        ...
        for (var e = n.length; --e >= 0; ) if (r < n[e]) return !1;
        return !0;
      }),
      ...
      (l.within = function (r, n, e) {
        ...
        return (
          l.infinite(r) || l.infinite(n) || l.infinite(e) || (r >= n && r <= e)
        );
      }),
      (l.object = function (r) {
      ...
      (l.primitive = function (r) {
        return (
          !r || !('object' == typeof r || l.object(r) || l.fn(r) || l.array(r))
        );
      }),
      (l.hash = function (r) {
        return (
